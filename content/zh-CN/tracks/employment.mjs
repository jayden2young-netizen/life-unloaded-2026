...
export const RECRUITMENT_SCENARIO_COPY=Object.freeze({
  ...
  E08:{situation:'海外招聘者先核工作授权和当地语言，再开始问项目。申请表上那一栏，不能拿“学校说大概可以”代替。',prompt:'资格先被摆到桌面上。你怎么继续？',choices:[
    {text:'继续找，但不把意向当录用',resultText:'你留着申请记录，继续等正式录用通知。',offerIntent:false,route:'overseas'},
    {text:'先停掉当地求职',resultText:'这批申请陆续撤回。学校经历还在，工作并没有跟着自动留下。',offerIntent:false,route:'overseas'},
  ...
  E14:{situation:'说好给结果的日期已经过去。邮箱里只有系统自动通知，招聘软件上的联系人没有再回。',prompt:'没有明确结果，你怎么处理这条申请？',choices:[
    ...
    {text:'今天先停一下',resultText:'你关掉招聘软件一天。第二天，待投岗位还在列表里。',offerIntent:false}
  ]}
});
...
export const EMPLOYMENT_COPY={
  ...
  decisions:[
    ...
    e({id:'first_job_application',lane:'career',phase:1,role:'start',delayYears:1,deadlineYears:5,age:[16,28],opportunity:{group:'career.firstJob',desires:['security','achievement','wealth'],response:'weight'}},
    ...
    e({id:'first_job_application',lane:'career',phase:2,role:'continue',delayYears:1,deadlineYears:5,age:[17,29]},
      '申请发出去了。笔试、作业、群面和面试，哪一种都可能来。学历低一截的被问为什么不继续读，高一截的又被追着要经验。总有一栏嫌你不够。',
      '下一轮真来了，你准备先讲什么？','面试稿改了几版。最顺口的，还是你真做过的那一段。',
      c('就讲做过的项目和上手有多快','经验短就是短。你没躲，挑了一件自己做过的，从怎么接手讲到哪里返过工。','这段经历不用等别人提醒，你也能从头讲清。'),
      c('把研究讲成他们听得懂的东西','半页论文背景删掉，只留问题、方法、结果和怎么与人合作。讲到行业经验时，你也承认这块还薄。','稿子里的专业深度还在，经验不足也没被漂亮话盖住。',{requirements:rules([q('education.researchEvidence','gte',1)])}),
    ...
    e({id:'first_job_application',lane:'career',phase:3,role:'continue',delayYears:1,deadlineYears:5,age:[18,30]},
      '招聘页面上，“录用”“意向”“补材料”几个词挨得很近。真走到报到，还要合同、工作资格和一个写得清楚的日期。',
      '下一轮申请，哪件事先问到底？','你把那几封邮件又看了一遍：哪封写了日期和合同，哪封只说“保持联系”，这回没再自欺。',
      c('把合同和报到条件问到底','你只把试用期、薪资、工作地点、职责和报到条件肯写清楚的岗位留在申请里。','写不清岗位、工资和报到日的，你都从“快有结果”那一栏删了。'),
      c('人在海外，先问雇主能不能办手续','岗位再合适，对方处理不了当前工作资格也走不下去。你一边筛掉不可能的，一边继续投剩下的。','当地没有一家公司肯把录用写下来。你留着材料继续投，不再拿口头意向当工作。',{requirements:rules([q('employment.applicationRegion','in',['us','europe'])])}),
      c('投国内岗位，先赶还开着的批次','学历材料补起来，项目说明也按国内岗位重写。错过的批次就是错过了，网页不会因为你在海外待过就重新开放。','你把还招人的岗位都投了。学历后面，做过的项目也一项项列清楚。',{requirements:rules([q('employment.applicationRegion','in',['us','europe'])])}),
      c('还是没有，接着投','你留着申请记录，有短项目就做一点，手里的钱也开始省着花。亲友问起时，你没编一家“快入职”的公司。','你仍在求职。刷新页面、改简历、等回信占满了白天，工牌却还没有。')),
    e({id:'first_job_application',lane:'career',phase:4,role:'continue',delayYears:1,deadlineYears:5,age:[19,31]},
      '最后等的一天到了。拿到录用的人开始准备报到，没拿到的还在刷消息。说到底，能不能去上班，得看那份合同来不来。',
      '这份工作，你怎么答？','最后一天也过去了。能去上班的人在找证件照，没等到合同的人第二天照样得起床。',
      c('接受这份 offer','你照合同上的岗位报到。工牌、排班或项目账号到手，第一段正式经验从新人该学的地方开始。','合同不算梦中情岗，工资和报到日倒都写得清楚。你签了。'),
      c('拒绝这份 offer','你把不合适的条款说清楚，没有拿“先进去再说”骗自己。招聘进度归零，下一次投递仍要从头来。','你回绝了那份工作。底线保住了，下个月房租也没有因此打折。'),
      c('继续寻找','你没有工牌，也没填一份假去向。招聘网站照旧要点开，下一次消息来了还得回。','合同没有来。你把闹钟照旧定好，明早继续找。',{requirements:rules([q('employment.applicationStatus','neq','offered')])})),
    e({id:'long_term_first_job_reentry',lane:'career',phase:1,role:'start',delayYears:1,deadlineYears:3,age:[26,58],lifecycle:{kind:'firstJobReentry',relativeTo:'firstJobFailureOrDecline',minYearsAfter:5}},
      '上一次首职失败或拒绝已经过去五年。招聘软件、旧联系人和本地公告推来的岗位越来越具体：县城门店、办公室、站点招人、回原来的城市住一阵。建议很多，合同仍要自己核。',
      '这批机会来了，你先怎么回？','那几条招聘信息没有替你做决定，求职边界却说清了。',
      c('写清底线和期限','你把不能接受的无薪试岗、模糊合同和最低开销写清，也给这一轮投递定了复核日期。','后来再看进度，期限和底线都还在。'),
      c('先去看看介绍来的岗位','你同意见人，不答应当场上班。岗位、合同、发薪日和谁负责，一项项问。','介绍仍是介绍，工作值不值得去有了单独的答案。'),
      c('不按别人给的方向走','你把不合适的链接收起来，继续按自己的方向投。','选择权保住了，现金却没有因此增加。')),
    e({id:'long_term_first_job_reentry',lane:'career',phase:2,role:'continue',delayYears:1,deadlineYears:3,age:[27,59]},
      '住处开销、社保和信用卡最低还款挤到同一周。简历还在投，银行卡不会等面试结果。短工、调整住处和继续找原行业工作，都开始有了具体价格。',
      '现金先从哪里松一口气？','这次调整很难体面。至少下个月的账单不再全靠假设。',
      c('把住处降到更省钱的安排','你重新核算搬动和日常成本，换到能撑更久的居住安排。通勤可能更远，求职方向没换。','后来收到面试通知时，地址已经换了。'),
      c('接一段合法短工','你核过计价、结算和装备费用，先接一段能停下来的活。白天或夜里工作，另一段时间继续投。','收入不稳定，必要开销先接上了。原方向的简历也没有扔。'),
      c('再扛一阵，不接眼前的','你拒绝了条件含糊的岗位，把花销压到最低。','不可靠的工作没接，现金继续往下掉。')),
    e({id:'long_term_first_job_reentry',lane:'career',phase:3,role:'resolve',delayYears:0,deadlineYears:3,age:[28,60]},
      ...
      c('继续按原区间求职','你保留短工或节流安排，继续投真正匹配的岗位。','求职还在继续。手里只有短工和节流安排，正式合同还没有来。'),
    ...
    e({id:'first_job_application',lane:'career',phase:5,role:'resolve',delayYears:0,deadlineYears:5,age:[20,32],lifecycle:{kind:'firstJobFallback'}},
      '又找了一年。现在有一份能报到的桥接岗位：资格、地区和合同都核过，岗位最多比你能走的正常入口低一档。原来的求职区间仍可以继续等，也可以先停下来。',
      '这一次，先接住什么？','这一年留下了合同、继续投递的记录，或一封暂停求职的消息。没有哪一份能把前面的空窗擦掉。',
      c('先接这份桥接岗位','你核对岗位、工资、合同和报到日后签了字。起点低了一档，第一份正式工作总算有了具体去处。','工牌是真的，岗位也照实写进履历；以后能走到哪里，还得从这份工作往下做。'),
      c('保留原区间，继续找','你没有把目标改成任何能进的岗位。投递继续，开销也按下一段空窗重新算。','新的招聘消息还会来，稳定工资暂时没有来。'),
      c('暂停或退出这一轮','你关掉提醒，通知还在联系的招聘方这轮先停。之后要不要回来，不在今天替未来答应。','求职停了下来。账单和日常没有一起暂停。')),
    e({id:'career_growth',lane:'career',phase:1,role:'start',delayYears:0,deadlineYears:1,age:[25,62],lifecycle:{kind:'careerGrowth',minTenureYears:3,employmentModes:['employed','gig']}},
      '这份工作已经连续做了三年。最近的排班、项目或交付里，你开始替别人收尾；用工方或负责人也约你谈下一段职责、合同和收入。新安排要落到实际工作上，不能只换个称呼。',
      '这次成长机会，你怎么接？','后来再看履历，这一年写下的是新职责、保留原岗，或一次没有通过的考核。',
      c('接下写明的新安排','新增职责、对应收入和生效日期写进了安排。你从约定那天起按新的范围做。','带人、培训、项目责任、技能岗位或专业级别，至少有一项成了真正做过的工作。'),
      c('保留现在的工作','你没有为了一个称呼接下没有边界的新任务。原来的岗位、合同和收入照旧。','下一次再谈时，对方不能把这次拒绝写成你已经做过那份工作。'),
      c('参加考核，再看结果','你按要求做完考核或试岗，新安排最后没有落下来。做过的材料留在手里，原岗位也没有被写成已经晋升。','这次没有升成。你知道差在哪，也没有拿一句“以后有机会”当结果。'))
  ]
};
