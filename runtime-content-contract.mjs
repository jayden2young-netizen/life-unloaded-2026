...
export const ATTITUDE_KEYS = Object.freeze([
  'swallow', 'pushBack', 'deadpan', 'note', 'lean', 'refuse',
]);
export const ONGOING_MODIFIERS = Object.freeze([
  'reliableCarePressure', 'guardedPartnerBond', 'delayHelpSeeking',
]);
...
export const READ_PATHS = Object.freeze([
  ...
  'mobility.platformYears',
  'originHousehold.context.emotionalSafety',
  'originHousehold.context.educationBudget',
  'originHousehold.context.educationCapital',
  ...
  'relationships.partnerHistoryCount',
  'relationships.parentLost',
  'relationships.lastParentLossAge',
  'relationships.lastParentLossPersonId',
  'social.primaryPersonId',
  'social.secondaryPersonId',
  'social.latestIntent',
  'outcomeTags.finance:limited_guarantee',
  'outcomeTags.finance:joint_guarantee',
  'outcomeTags.parentLoss:firstCall',
  'outcomeTags.parentLoss:inheritance',
  'outcomeTags.parentLoss:belongings',
  'outcomeTags.parentLoss:contact',
  'housing.status',
  'housing.value',
  'housing.arrangement',
  'housing.region',
