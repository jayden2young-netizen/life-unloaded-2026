...
- `main` 开发基线：`3323780ecfadba1dd7fa328ba9b4585a41a83d1e`
- 基线提交说明：`Merge v0.5.7 crisis and recovery episodes`
- 开发分支：`codex/v0.5.8-family-migration`
- 基线版本：`v0.5.7`
...
远程、伴侣和子女轨道的六条旧四节点链已删除，改为14条独立短簇：关系建立、婚姻危机、离婚、复合、晚年相伴；成为父母、收养、入学、青春期边界、成年子女边界；第一份远程合同、平台依赖、海外许可和建立基地。教育、开店与晚年旧链继续留给 v0.5.9。
...
- 教育：中考分流、大学中断、考证和成年再教育独立成簇。
- 晚年：退休、父母遗产、长期照护和遗嘱独立成簇。
- 企业扩张与财富顶点另开新簇，保留已经完成的 `shop_opening`。
- 迁移教育、经营和晚年剩余五条旧四节点链，再统一删除旧 arc 控制器。
- 全轨时间线、故事线、家庭秘密与结局文案做最终复盘和清理。
