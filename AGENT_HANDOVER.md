...
更新时间：2026-08-27。这里只记录换窗口或换电脑后立即需要的当前事实，不保存版本历史和通用开发规则。
...
| 版本 | v0.7.0／Schema 14／Content Revision 36 |
| 内容 | 965 个事件：517 beat、214 decision、214 consequence、20 blackSwan；83 张卡牌、30 种家庭、44 个秘密、90 个结局标题、42 个图鉴条目 |
| 数据 | `data.json` SHA-256：`b4dbfff5dbaf81fe4e2316b1deffffc0fe6e4445edcaee04fa007155e31eb5da` |
| 旧版 | `legacy/0.6.13` 在本地与 origin 均固定到 `9bc9dc7` |
| 发布 | v0.7.0 已合并到 `main`、推送并由 GitHub Pages 发布；本轮已核对远端 ref、Pages 目标提交和四个线上产物 |
| 验证 | 正式生成器双跑 byte-stable；最终 `node smoke.js --full` 八组全部通过；320×568、360×640、360×773 与 1280×800 代表界面控制台错误为 0 |
