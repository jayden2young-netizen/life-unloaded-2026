...
| 发布核对 | 功能发布提交 `40605a3` 的 Pages 构建成功；线上 `index.html`、`game.js`、运行时合同与 `data.json` 已和本地逐项核对 |
...
- GitHub Pages 已成功部署；线上 `game.js`、运行时合同与 `data.json` 哈希均和本地一致，线上页面明确显示 v0.6.11。
