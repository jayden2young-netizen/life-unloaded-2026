...
- 线上与本地：v0.6.11／Schema 13／Content Revision 29。
- Git：`main` 为 v0.6.11 发布线；`legacy/0.6.10@b84b480` 固定上一公开版本。
- 下一步：等待用户继续试玩，并单独决定是否启动 v0.6.12。
...
| 版本 | 发布状态 | 主要范围 |
|---|---|---|
| v0.6.11 | 已发布 | 全库文案、Episode 呈现与状态面板收口；Schema 13／Revision 29 |
...
- v0.6.11 发布前基线为 `b84b480`，已固定为 `legacy/0.6.10`。当前发布数据 SHA-256 为 `b44740be04f545eba79eb16eb826bad3652191e72fda1add95dbee6686536209`；后续版本仍须重新现场核对。
